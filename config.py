...
class Config(object):
    ...
    TECH_VJ_URL = environ.get('TECH_VJ_URL', 'www.paisakamalo.in') # your shortlink url domain or url without https://
    TECH_VJ_API = environ.get('TECH_VJ_API', 'da4663b1ecc869620f74c1fed85b23d6f55f3da0') # your url shortner api
